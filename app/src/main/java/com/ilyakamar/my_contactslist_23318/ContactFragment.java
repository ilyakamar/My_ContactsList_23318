...
import com.ilyakamar.my_contactslist_23318.utils.ContactPropertyListAdapter;
...
public class ContactFragment extends Fragment {
    ...
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {// onCreateView
    ...
    public void onResume() {
        ...
        if (contactID > -1 ){// if the contact doesn't still exists then navigate back popping the stack
            init();
        }
        else {
